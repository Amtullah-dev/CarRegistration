...
from schemas import ma, UserSchema, CarSchema
import requests
import datetime
import os
...
try:
    from celery_worker_sqlite import make_celery
...
def sync_cars():
    ...
    if celery is None:
        ...
        try:
            from celery_worker_sqlite import sync_car_data_function
    ...
    try:
        ...
        try:
            from celery_worker_sqlite import sync_car_data_task
            task = sync_car_data_task.delay()
        except ImportError:
            from celery_worker import sync_car_data_task
            task = sync_car_data_task.delay()
...
if __name__ == '__main__':
    with app.app_context():
        ...
        try:
            ...
            try:
                from celery_worker import sync_car_data_function
                sync_car_data_function()
            except ImportError:
